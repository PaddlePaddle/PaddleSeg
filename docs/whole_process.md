...
Our demo uses the `optic disc segmentation dataset` for training. It is one of dozens datasets that we support. You can refer to [Datasets prepare](./data_prepare.md) to use other datasets we support or [Prepare your own data](./data/custom/data_prepare.md) to prepare your own data.
