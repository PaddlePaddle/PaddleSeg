...
<ul class="nobull">
  <li>[2022-08-18] :fire: PaddleLabel, an intelligent annotation tool has been released in beta. It can adapt to tasks such as classification, detection, and segmentation. For more details, please refer to <a href="./contrib/PaddleLabel/README.md">PaddleLabel</a>. </li>
