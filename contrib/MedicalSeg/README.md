...
###  1. Accuracy
We add several SOTA segmentation model into our repository including nnUNet,nnFormer, SwinUNet and TransUNet. Each of then surpass the original implementation in different extend. Among them, TransUNet surpass the original implementation by 3.6% and reach a mDice of 81.8%. We present all of our model in the following tabular. and you are welcome to see the vdl log to see the training process or you can use the pretrained model to improve the performance of your model.
...
|Lung tumor|[MSD-Lung](http://medicaldecathlon.com/)|[nnUNet](https://www.nature.com/articles/s41592-020-01008-z)|67.996%|[README](configs/nnunet/msd_lung/README.md)|[model](https://aistudio.baidu.com/aistudio/datasetdetail/162872)  \| [log](https://aistudio.baidu.com/aistudio/datasetdetail/150774)|
|Spine|[MRISpineSeg](https://www.spinesegmentation-challenge.com/)|[Vnet](https://arxiv.org/abs/1606.04797)|74.69%|[README](configs/mri_spine_seg/README.md)|[model](https://bj.bcebos.com/paddleseg/paddleseg3d/mri_spine_seg/vnet_mri_spine_seg_512_512_12_15k_5e-1/model.pdparams) \| [log](https://bj.bcebos.com/paddleseg/paddleseg3d/mri_spine_seg/vnet_mri_spine_seg_512_512_12_15k_5e-1/train.log) \| [vdl](https://www.paddlepaddle.org.cn/paddle/visualdl/service/app/index?id=08b0f9f62ebb255cdfc93fd6bd8f2c06)|
