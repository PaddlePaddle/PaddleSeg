...
save_dir=saved_model_develop/${yml}_1027_seed42_ema
mkdir -p ${save_dir}
...
# --resume_model  saved_model_develop/deeplabv2_resnet101_os8_gta5cityscapes_1280x640_160k_newds_gta5src_1025_seed42/iter_41000/ \
