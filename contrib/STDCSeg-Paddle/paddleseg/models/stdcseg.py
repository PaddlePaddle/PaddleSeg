...
class STDCSeg(nn.Layer):
    ...
    Args:
        backbone(str,optional): Backbone network discription, 'STDCNet1446'/'STDCNet813'. STDCNet1446->STDC2,STDCNet813->STDC813.
        num_classes(int,optional): The unique number of target classes.
        pretrain_model(str,optional): Backbone's pre-trained model params path. only for training,it should be needed. it should be None at EVAL Mode.
    ...
    """
    def __init__(self, backbone, num_classes, pretrain_backbone_model=None, use_boundary_2=False, use_boundary_4=False,
        ...
        self.cp = ContextPath(backbone, pretrain_backbone_model, use_conv_last=use_conv_last)
