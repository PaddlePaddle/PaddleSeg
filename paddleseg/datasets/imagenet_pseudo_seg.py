...
class ImagenetPseudoSeg(Dataset):
    ...
    def __init__(self,
        ...
        if mode not in ['train']:
            raise ValueError(
                "mode should be 'train', but got {}.".format(mode))
        ...
        class_id_file = os.path.join(label_dir, "imagenet_lsvrc_2015_synsets.txt")
    ...
    def __getitem__(self, idx):
        ...
        label[label < 9] = 1000    # [0, 999] for imagenet classes, 1000 for background.
