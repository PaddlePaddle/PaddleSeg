...
class PPHGNet(nn.Layer):
    ...
    def __init__(self, stem_channels, stage_config, layer_num, pretrained=None):
        super().__init__()

        self.feat_channels = [stem_channels[-1]]
        self.out_index = []
        ...
        for i, key in enumerate(stage_config):
