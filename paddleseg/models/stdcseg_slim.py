...
class STDCSeg_slim(nn.Layer):
    ...
    def __init__(self,
        ...
        self.conv_out_sp8 = SegHead(128, 64, 1)
...
class ContextPath(nn.Layer):
    ...
    def forward(self, x):
        ...
        avg_up = F.interpolate(avg, feat32_hw, mode='bilinear')

        feat32_arm = self.arm32(feat32)
        feat32_sum = feat32_arm + avg_up
        feat32_up = F.interpolate(feat32_sum, feat16_hw, mode='bilinear')
        feat32_up = self.conv_head32(feat32_up)

        feat16_arm = self.arm16(feat16)
        feat16_sum = feat16_arm + feat32_up
        feat16_up = F.interpolate(feat16_sum, feat8_hw, mode='bilinear')
